//Creating an object for the insults and their functions. ramsayInsults includes each insult in an array with the format of [text, image src].
const gordonRamsay = {};


//Hiding the answer section to start with
$("section").hide();
